...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 59389 finding_best_student_model.py \
  ...
  --student_encoder_pretrained_dir  ../result/MVTec3D-AD_experiment/potato/vae_training/3_TS_encoder_normal_anormal_aug/vae_student_model \
  --output_dir ../result/MVTec3D-AD_experiment/potato/vae_training/3_TS_encoder_normal_anormal_aug/inference_finding_best_epoch \
  --resolution 512,512 \
  --seed 42