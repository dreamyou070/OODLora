...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 55489 discrete_timeseries.py \
  ...
  --wandb_init_name bagel_training --wandb_run_name 6_discrete_timeseries \
  --seed 42 --output_dir ../result/MVTec_experiment/bagel/6_discrete_timeseries \
