...
accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_5_config --main_process_port 50189 training_end_to_end.py \
  ...
  --wandb_init_name bagel_training --wandb_run_name 5_train_end_to_end \
  --seed 42 --output_dir ../result/MVTec_experiment/bagel/5_train_end_to_end \
