NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 52009 ad_recon.py \
  ...
  --num_ddim_steps 200 --final_noising_time 980 --cross_map_res [64,32] --pixel_copy