...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 50939 inference.py \
  ...
  --num_ddim_steps 50 --final_noising_time 980 --pixel_mask_res 16 --pixel_thred 0.45 \
  --cross_map_res [16] --other_token_preserving --inner_iteration 1 --mask_thredhold 0.5