...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 59194 inference.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/carrot/lora_training/5_res_32_up_down_normal_30_anormal_50/models \
  --start_epoch 0
