...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 54339 inference.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/9_lora_diff_trining_16_res_attnmap_attn_loss/epoch-000012.safetensors \
  --resolution 512,512 --seed 42 \
  --cross_map_res [16] --pixel_mask_res 16 \
  --mask_thredhold 0 \
  --num_ddim_steps 1000 \
  --final_noising_time  30 \
