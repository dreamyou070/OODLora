...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 59332 inference.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/cable_gland/lora_training/res_64_up_16_up_normal_10_char_30_anormal_80_bent_120/models \
  --start_epoch 0
