...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 50505 inference.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/cookie/lora_training/res_64_up_32_up_down_normal_10_anormal_80/models \
  --start_epoch 0
