...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 50939 inference.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/2_training_16res_with_CrossEntropy/epoch-000004.safetensors \
  --num_ddim_steps 50 --final_noising_time 980 --pixel_mask_res 16 --pixel_thred 0.3 \
  --cross_map_res [16] --other_token_preserving --inner_iteration 1