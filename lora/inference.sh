...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 50333 inference.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/dowel/lora_training/res_64_up_normal_10_anormal_80/models
# -------------------------------------------------------------------------------------------------------------------------------------------- #
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 51661 inference_cookie.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/cable_gland/lora_training/res_64_up_16_up_normal_10_anormal_80/models