...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 50939 inference.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/8_anormal_sample_training_not_use_attn_loss_more_hole_good_captio_use/epoch-000005.safetensors \
