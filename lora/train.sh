...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 52189 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/2_2_training_16res_with_CrossEntropy_text_position_change_not_anormal_training \
