...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 52489 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/4_anormal_sample_training_crossattn_map --cross_map_res [64,32,16,8]