...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 50808 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/potato/lora_training/res_64_up
