...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 57111 train.py \
  ...
  --train_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD/cable_gland/train_ex_2/rgb \
  --output_dir ../result/MVTec3D-AD_experiment/cable_gland/lora_training/res_64_up_16_up_normal_10_char_30_anormal_80_bent_120 \
  --network_weights ../result/MVTec3D-AD_experiment/cable_gland/lora_training/res_64_up_16_up_normal_10_char_30_anormal_80_bent_120/models/epoch-000006.safetensors \
  --start_epoch 6 \
  --cross_map_res [64,16] \
  --trg_position "['up']"