...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 52040 train.py \
  ...
  --wandb_init_name carrot --start_epoch 0 --train_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD/carrot/train_normal/rgb \
  --output_dir ../result/MVTec3D-AD_experiment/carrot/lora_training/13_res_64_up_16_up_only_normal \
