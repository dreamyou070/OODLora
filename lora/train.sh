...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 52289 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/2_3_training_16res_with_CrossEntropy_text_position_change_anormal_training \
  --cross_map_res [16] --mask_res 16 --anormal_training