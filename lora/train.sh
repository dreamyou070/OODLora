...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 52589 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/6_anormal_sample_training_crossattn_map_divide_cross_map_num --truncate_pad --truncate_length 3 --cross_map_res [64,32,16,8]
