...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 51789 lora_mytraining.py \
  ...
  --logging_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/7_2_lora_diff_trining_64_res_attnmap_attn_loss/logs \
  --wandb_run_name 7_2_lora_diff_trining_64_res_attnmap_attn_loss --cross_map_res [64] \
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/7_2_lora_diff_trining_64_res_attnmap_attn_loss