...
# srun -p suma_a6000 -q big_qos --job-name=lora_train_trunc --gres=gpu:2 --time=48:00:00 --pty bash -i
# conda activate venv_lora


NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 52389 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/3_anormal_sample_training_text_truncate --cross_map_res [64,32,16,8] --truncate_pad --truncate_length 3