...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 51089 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/10_lora_diff_trining_8_res_attnmap_attn_loss \
  --cross_map_res [8]