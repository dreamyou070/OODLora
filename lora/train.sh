...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 57545 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/carrot/lora_training/6_res_32_up_normal_30_anormal_50 \
  --network_weights ../result/MVTec3D-AD_experiment/carrot/lora_training/6_res_32_up_normal_30_anormal_50/models/epoch-000010.safetensors \
  --start_epoch 10 \
  --cross_map_res [32] \
  --trg_position "['up']"