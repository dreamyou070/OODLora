...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 50088 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/cable_gland/lora_training/res_64_up_16_up_normal_10_anormal_80_bent_120 \
  --network_weights ../result/MVTec3D-AD_experiment/cable_gland/lora_training/res_64_up_16_up_normal_10_anormal_80_bent_120/models/epoch-000011.safetensors \
  --start_epoch 11 \
  --cross_map_res [64,16] \
  --trg_position "['up']"
