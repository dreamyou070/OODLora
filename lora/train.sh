...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 50189 train.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/1_2_training_64res_with_CrossEntropy \
