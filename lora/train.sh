...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 50606 train.py \
  ...
  --train_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD/foam/train_ex/rgb \
  --valid_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD/foam/test_ex/rgb \
  --output_dir ../result/MVTec3D-AD_experiment/foam/lora_training/res_64_up
