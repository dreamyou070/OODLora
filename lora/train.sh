...
# srun -p suma_a6000 -q big_qos --job-name=lora_10 --gres=gpu:2 --pty bash -i

NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 50889 train.py \
  --process_title parksooyeon --max_token_length 77 --log_with wandb --wandb_api_key 3a3bc2f629692fa154b9274a5bbe5881d47245dc --wandb_init_name bagel_lora \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/8_3_lora_diff_trining_32_res_attnmap_attn_loss_32mask_short_text_condition \
  --cross_map_res [32]