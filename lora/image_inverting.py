...
def main(args) :
    ...
    for class_name in classes:
        ...
        for test_img in test_images:
            ...
            save_base_folder = os.path.join(class_base_folder, f'interpolate_matrix_{concept_name}_pretrain_lora_cond_text_interpolation_{args.interpolate_alpha}_inference_time_{args.num_ddim_steps}')
