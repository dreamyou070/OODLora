...
save_folder="1_1_res_64_up_16_up_no_back_cls_training_from_108epoch"
output_dir="../result/MVTec3D-AD_experiment/${class_name}/lora_training/${normal_folder}/${save_folder}"
network_weights="../result/MVTec3D-AD_experiment/${class_name}/lora_training/normal/1_1_res_64_up_16_up_no_back_cls_training/models/epoch-000108.safetensors"
port_number=54108
start_epoch=0
