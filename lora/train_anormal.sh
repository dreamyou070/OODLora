...
save_folder="1_3_res_64_down_32_up_no_back_cls_training"
output_dir="../result/MVTec3D-AD_experiment/${class_name}/lora_training/${normal_folder}/${save_folder}"
network_weights="../result/MVTec3D-AD_experiment/${class_name}/lora_training/normal/1_3_res_64_down_32_up_no_back_cls_training/models/epoch-000110.safetensors"
port_number=54110
start_epoch=0
