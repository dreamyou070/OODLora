...
ml purge
ml load cuda/11.0
# nohup sh autoencoder_training_3.sh > ../result/printing_screen/3_vae_decoder_training_uniform_initialize.txt
accelerate launch --config_file ../../../gpu_config/gpu_6_7_config --main_process_port 56789 -u autoencoder_training_3.py \
