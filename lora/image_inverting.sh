python sy.py --device cuda:1 \
  --process_title parksooyeon \
  --output_dir '/data7/sooyeon/Lora/OODLora/result/MVTec_experiment/bagel/1_first_experiment/test_result/contamination_threshold_time_500' \
