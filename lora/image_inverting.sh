python image_inverting.py --device cuda:5 \
  ...
  --network_weights '/data7/sooyeon/Lora/OODLora/result/MVTec_experiment/bagel/7_contrastive_learning/epoch-000004.safetensors' \
  --prompt 'good' --inversion_experiment --sample_sampler ddim --num_ddim_steps 50 \
  --output_dir '/data7/sooyeon/Lora/OODLora/result/MVTec_experiment/bagel/7_contrastive_learning/inference_check' \
