python image_inverting.py --device cuda:5 \
  ...
  --network_weights '../../../result/MVTec_experiment/bagel/2_contrastive_learning_eps_0.0_new_code_highrepeat/epoch-000005.safetensors' \
  --prompt 'good' \
  --inversion_experiment \
  --sample_sampler ddim \
  --num_ddim_steps 50 \
  --output_dir '../../../result/MVTec_experiment/bagel/2_contrastive_learning_eps_0.0_new_code_highrepeat' \
