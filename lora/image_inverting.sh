python image_inverting.py --device cuda:5 \
  ...
  --prompt 'normal' --concept_image_folder /data7/sooyeon/medical_image/experiment_data/MV/bagel/train/good/rgb \
  --sample_sampler ddim --num_ddim_steps 50 --threshold_time 0
