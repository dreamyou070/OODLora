...
class NetworkTrainer:
    ...
    def train(self, args):
        ...
        def save_model(ckpt_name, unwrapped_nw, steps, epoch_no, force_sync_upload=False):
            ...
            ckpt_file = os.path.join(model_dir, ckpt_name)
        ...
        for epoch in range(args.start_epoch, args.start_epoch+num_train_epochs, 1):
            ...
            if args.save_every_n_epochs is not None:
                ...
                if is_main_process and saving:
                    ...
                    training_text_embeddings_save_dir = os.path.join(embeddings_save_dir, f'training_text_embeddings-{str(epoch+1).zfill(6)}.pt')
