...
def main(args):
    ...
    center_folders = os.path.join(parent, f'reconstruction_20240128_up_blocks_1_attentions_2_transformer_blocks_0_attn2_pca_dim_320/centers')
    ...
    for weight in network_weights:
        ...
        if accelerator.is_main_process:
            ...
            ## (3.1) base dir
            condition_save_dir = os.path.join(test_lora_dir, f'memory_bank_{args.cross_map_res[0]}_{args.trg_part[0]}_reconstruction_test')
