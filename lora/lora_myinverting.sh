...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 53339 lora_myinverting.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/6_2_lora_diff_trining_all_res_attnmap_attn_loss/epoch-000006.safetensors \
