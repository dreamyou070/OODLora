NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 51234 train_layerwise_text_embedding.py \
  ...
  --wandb_init_name bagel_lora_emgedding \
  ...
  --class_caption 'good' \
  --start_epoch 0 \
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/res_64_32_16_up_down_text_embedding_with_anormal_emb_anormal_training \
