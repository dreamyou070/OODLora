accelerate launch --config_file /data7/sooyeon/LyCORIS/gpu_config/gpu_4_5_config --main_process_port 24524 training_contrastive.py \
  ...
  --wandb_init_name 'bagel_training' --wandb_run_name 2_contrastive_learning_eps_0.0_new_code \
  --seed 42 --output_dir ../result/MVTec_experiment/bagel/2_contrastive_learning_eps_0.0_new_code \
