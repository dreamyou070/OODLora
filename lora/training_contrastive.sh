...
# start of the script
#!/bin/bash
# sbatch -q big_qos --nodes 2 --output=../result/printing_screen/2_contrastive_learning_eps_0.0_new_code_highrepeat_test.txt training_contrastive.sh >../result/printing_screen/2_contrastive_learning_eps_0.0_new_code_highrepeat.txt 2>&1
...
accelerate launch --config_file /data7/sooyeon/LyCORIS/gpu_config/gpu_6_7_config --main_process_port 57189 training_contrastive.py \
