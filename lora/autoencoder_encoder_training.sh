...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config --main_process_port 50489 autoencoder_encoder_training.py \
  ...
  --logging_dir ../result/MVTec3D-AD_experiment/cable_gland/vae_training/4_TS_encoder_normal_no_aug \
  --output_dir ../result/MVTec3D-AD_experiment/cable_gland/vae_training/4_TS_encoder_normal_no_aug \
