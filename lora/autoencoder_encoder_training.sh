...
# dreamyou070
# qkrtndus0701?!
# srun -p suma_a6000 -q big_qos --gres=gpu:4 --job-name=bagel_2 --time=48:00:00 --pty bash -i
# conda activate venv_lora
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config --main_process_port 50389 autoencoder_encoder_training.py \
  ...
  --wandb_run_name 3_TS_encoder_normal_aug \
  ...
  --valid_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD_Experiment_SDXL/bagel/test_normal/bad