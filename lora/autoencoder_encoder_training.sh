...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config --main_process_port 50389 autoencoder_encoder_training.py \
  ...
  --logging_dir ../result/MVTec3D-AD_experiment/cable_gland/vae_training/3_TS_encoder_normal_aug \
  --output_dir ../result/MVTec3D-AD_experiment/cable_gland/vae_training/3_TS_encoder_normal_aug \
  --train_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD_Experiment_SDXL/cable_gland/train_normal/bad \
  --valid_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD_Experiment_SDXL/cable_gland/test_normal/bad