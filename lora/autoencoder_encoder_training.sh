...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config --main_process_port 50389 autoencoder_encoder_training.py \
  ...
  --wandb_run_name 1_TS_encoder_normal_no_aug \
  --logging_dir ../result/MVTec3D-AD_experiment/bagel/vae_training/1_TS_encoder_normal_no_aug \
  --output_dir ../result/MVTec3D-AD_experiment/bagel/vae_training/1_TS_encoder_normal_no_aug \
  --train_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD_Experiment_SDXL/bagel/train/bad \
