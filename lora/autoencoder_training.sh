...
accelerate launch --config_file ../../../gpu_config/gpu_4_5_config --main_process_port 54589 autoencoder_training.py \
  ...
  --seed 42 --output_dir ../result/MVTec_experiment/bagel/3_contrastive_learning_eps_0.0_increase_generality \
  ...
  --train_data_dir ../../../MyData/anomaly_detection/autoencoder_training \
  --class_caption 'good' \
  --contrastive_eps 0.0
