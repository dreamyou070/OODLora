...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 50189 lora_mytraining.py \
  ...
  --wandb_run_name 2_1_lora_trining_using_noise_diff_map_res_8 \
  --seed 42 \
  --output_dir ../result/MVTec3D-AD_experiment/potato/unet_training/2_1_lora_trining_using_noise_diff_map_res_8 \
