...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 51189 lora_mytraining.py \
  ...
  --log_with wandb --wandb_api_key 3a3bc2f629692fa154b9274a5bbe5881d47245dc --wandb_init_name test \
  --wandb_run_name 1_lora_trining_all_res_attnmap_noise_diff \
  --seed 42 \
  --output_dir ../result/MVTec3D-AD_experiment/bagel/test/1_lora_trining_all_res_attnmap_noise_diff \
  ...
  --class_caption 'good' --contrastive_eps 0.0 --start_epoch 0 --cross_map_res [64,32,16,8]
