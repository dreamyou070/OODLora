...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config --main_process_port 52089 lora_mytraining.py \
  ...
  --train_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD/bagel/train/bad \
  --valid_data_dir ../../../MyData/anomaly_detection/MVTec3D-AD/bagel/test/bad --seed 42 --class_caption 'good' --contrastive_eps 0.0 --start_epoch 0 \
  --logging_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/10_lora_8_trining_all_res_attnmap/logs \
  --wandb_run_name 10_lora_8_trining_all_res_attnmap --cross_map_res [8] \
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/10_lora_8_trining_all_res_attnmap