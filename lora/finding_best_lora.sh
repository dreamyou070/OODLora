...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 52839 finding_best_lora.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/2_training_16res_with_CrossEntropy/epoch-000008.safetensors \
