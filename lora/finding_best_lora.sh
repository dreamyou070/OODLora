...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 54339 finding_best_lora.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/9_lora_diff_trining_16_res_attnmap_attn_loss/epoch-000001.safetensors \
