...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 50239 finding_best_lora.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/8_3_lora_diff_trining_32_res_attnmap_attn_loss_32mask_short_text_condition/epoch-000003.safetensors \
