...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 50539 finding_best_lora.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/7_lora_diff_trining_64_res_attnmap_attn_loss/epoch-000005.safetensors \
