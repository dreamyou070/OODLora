...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 54239 finding_best_lora.py \
  ...
  --network_weights ../result/MVTec3D-AD_experiment/bagel/lora_training/8_3_lora_diff_trining_32_res_attnmap_attn_loss_32mask_short_text_condition/epoch-000001.safetensors \
  --resolution 512,512 --seed 42 \
  --cross_map_res [32] --pixel_mask_res 32 \
  --mask_thredhold 0 \
  --num_ddim_steps 1000 \
  --final_noising_time  100 \
  --pixel_thred 0 --other_token_preserving --calculating_anomality_score