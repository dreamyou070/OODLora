NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port 53211 train_layerwise_text_embedding.py \
  ...
  --output_dir ../result/MVTec3D-AD_experiment/bagel/lora_training/res_32_up_down_text_embedding_reswise_attnloss --network_train_unet_only \
  --cross_map_res [32,16] --use_attn_loss --normal_activation_train --trg_position "['up','down']" --resolution_wise_attn_loss