...
save_folder="res_64_down_1_mahal_attn_0.008_act_deact_text_frozen"
output_dir="../result/${data_folder}_experiment/${class_name}/lora_training/${normal_folder}/${save_folder}"
network_weights="../result/MVTec3D-AD_experiment/${class_name}/lora_training/${normal_folder}/res_64_down_1_mahal_attn_0.008_act_deact/models/epoch-000002.safetensors"
start_epoch=0
port_number=58800
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config \
  ...
  --attn_loss --attn_loss_weight 0.008 --cls_training --back_training \
