...
save_folder="res_64_up_attn2_t_2_attn210_sub_module_only_activating"
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_config \
  ...
  --trg_part '["attn_2","attn_1","attn_0"]' --cls_training # --all_same_learning  --network_weights "$network_weights"
