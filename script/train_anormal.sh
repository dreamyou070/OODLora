...
save_folder="res_64_up_attn2_t_2_attn2_data_40"
output_dir="../result/${data_folder}_experiment/${class_name}/lora_training/${normal_folder}/${save_folder}"
network_weights="../result/${data_folder}_experiment/${class_name}/lora_training/${normal_folder}/res_64_up_attn2_t_2_attn2/models/epoch-000004.safetensors"
start_epoch=0
port_number=55588
