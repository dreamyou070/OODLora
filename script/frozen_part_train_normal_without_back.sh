...
save_folder="res_64_up_attn2_t_2_attn2_from_normal_frozen_only_small_update_only_normal_high_score_with_text_encoder"
output_dir="../result/${data_folder}_experiment/${class_name}/lora_training/${normal_folder}/${save_folder}"
network_weights="../result/${data_folder}_experiment/${class_name}/lora_training/normal/res_64_up_attn2_t_2_attn2_normal/models/epoch-000005.safetensors"
