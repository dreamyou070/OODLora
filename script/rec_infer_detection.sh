...
detection_network_weights="../result/${data_folder}_experiment/${class_name}/lora_training/normal/res_64_up_attn012_t_2_only_normal/models/epoch-000006.safetensors"
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config \
  ...
  --detection_network_weights ${network_weight_folder} \
  --cross_map_res [64] \
  --trg_position "['up']" \
  --trg_part "['attn_2']" \
  --num_ddim_steps 50 \
