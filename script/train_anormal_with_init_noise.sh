...
save_folder="res_16_32_64_up_t_2_20240128_with_gaussian_init_noise"
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_2_3_4_config \
  ...
  --trg_part '["attn_0","attn_1","attn_2"]' --cls_training --all_same_learning # --network_weights "$network_weights"
