...
save_folder="res_64_up_attn012_t_2_only_normal_total_text_attn2_normal_init_gaussian_noise_unet_frozen_none_act_deact"
output_dir="../result/${data_folder}_experiment/${class_name}/lora_training/${normal_folder}/${save_folder}"
network_weights="../result/${data_folder}_experiment/${class_name}/lora_training/${normal_folder}/res_64_up_attn012_t_2_only_normal/models/epoch-000005.safetensors"
