...
save_folder="res_64_up_attn_2_20240128_t_2_with_contrast_cls_training_all_text_only_object_anomal_p_0.5"
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_1_config \
  ...
  --cross_map_res "[64]" \
  --detail_64_up \
  --trg_position "['up']" --truncate_pad --truncate_length 2 \
  --trg_part '["attn_2"]' --contrast --cls_training