...
save_folder="res_64_down_task_loss_mahal_dist_attn_loss_0.01_actdeact_perlin_noise_second_code"
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config \
  ...
  --do_attn_loss --attn_loss_weight 0.01 --cls_training --back_training \
