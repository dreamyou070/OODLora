...
save_folder="res_64_up_2_task_loss_mahal_dist_attn_loss_0.008_actdeact_mahal_anomal_from_2"
output_dir="../result/${data_folder}_experiment/${class_name}/lora_training/${normal_folder}/${save_folder}"
network_weights="../result/MVTec3D-AD_experiment/${class_name}/lora_training/${normal_folder}/res_64_up_2_task_loss_mahal_dist_attn_loss_0.008_actdeact_mahal_anomal/models/epoch-000002.safetensors"
start_epoch=0
port_number=58860
