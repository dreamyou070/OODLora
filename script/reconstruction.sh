...
class_name="bagel"
folder_name="res_64_down_attn1_text_attnloss_weight_0.001"
...
NCCL_P2P_DISABLE=1 accelerate launch --config_file ../../../gpu_config/gpu_0_config --main_process_port ${port_number} ../lora/reconstruction.py \
  ...
  --trg_layer_list "['down_blocks_0_attentions_1_transformer_blocks_0_attn2']" --only_zero_save
    ...
    #"['down_blocks_0_attentions_0_transformer_blocks_0_attn2', 'down_blocks_0_attentions_1_transformer_blocks_0_attn2',
