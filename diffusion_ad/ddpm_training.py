...
from data.dataset_beta_thresh import MVTecTrainDataset, MVTecTestDataset, VisATrainDataset, VisATestDataset, \
    DAGMTrainDataset, DAGMTestDataset, MPDDTestDataset, MPDDTrainDataset
...
def train(training_dataset_loader, testing_dataset_loader, args, data_len, sub_class, class_type, device):
    ...
    temp = {"classname": [sub_class], "Image-AUROC": [best_image_auroc], "Pixel-AUROC": [best_pixel_auroc],
            "epoch": best_epoch}
...
def main():
    ...
    for sub_class in current_classes:
        ...
        training_dataset = MVTecTrainDataset_sy(subclass_path,
                                             sub_class,
                                             img_size=args["img_size"],
                                             args=args)
        testing_dataset = MVTecTestDataset_sy(subclass_path,
                                           sub_class,
                                           img_size=args["img_size"], )
        class_type = 'MVTec'
        print(file, args)
